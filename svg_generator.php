...
<svg width="{{shelfX}}" height="{{shelfY}}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	...
	<defs>
		<style type="text/css">
		<![CDATA[
		rect {fill:yellow; stroke:black; stroke-width: 2px;}
		.section {fill:blue; stroke:black; stroke-width: 2px; opacity:.8;}
		]]>
		</style>
	</defs>
	
	<rect id="shelf{{shelfID}}" x="0" y="0" width="{{shelfX}}" height="{{shelfY}}" style="fill:green;stroke:black;" stroke-width="2" />
	{{sections}}
</svg>
';
